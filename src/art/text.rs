...
fn make_a_render() -> Packet {
    ...
    let bot_left_right = Vertex::new([0.2, 0.0, 0.0]); //1
    let top_mid_left = Vertex::new([0.4, 1.0, 0.0]); //2
    let top_mid_right = Vertex::new([0.6, 1.0, 0.0]); //3
    let mid_left_top = Vertex::new([0.23, 0.4, 0.0]); //4
    let mid_left_bot = Vertex::new([0.18, 0.2, 0.0]); //5
    let mid_right_top = Vertex::new([0.77, 0.4, 0.0]); //6
    let mid_right_bot = Vertex::new([0.82, 0.2, 0.0]); //7
    let bot_right_left = Vertex::new([0.8, 0.0, 0.0]); //8
...
fn make_b_render() -> Packet {
    ...
    let bot_left_in = Vertex::new([0.2, 0.2, 0.0]); //1
    let top_left_out = Vertex::new([0.0, 1.0, 0.0]); //2
    let top_left_in = Vertex::new([0.2, 0.8, 0.0]); //3
    let mid_left_top = Vertex::new([0.2, 0.6, 0.0]); //4
    let mid_left_bot = Vertex::new([0.2, 0.4, 0.0]); //5
    let top_right_top_out = Vertex::new([0.75, 1.0, 0.0]); //6
    let top_right_top_in = Vertex::new([0.6, 0.8, 0.0]); //7
    let top_right_right_out = Vertex::new([1.0, 0.75, 0.0]); //8
    let top_right_right_in = Vertex::new([0.75, 0.75, 0.0]); //9
    let mid_right_top = Vertex::new([0.6, 0.4, 0.0]); //10
    let mid_right_bot = Vertex::new([0.6, 0.6, 0.0]); //11
    let bot_right_right_out = Vertex::new([1.0, 0.25, 0.0]); //12
    let bot_right_right_in = Vertex::new([0.75, 0.25, 0.0]); //13
    let bot_right_bot_out = Vertex::new([0.75, 0.0, 0.0]); //14
    let bot_right_bot_in = Vertex::new([0.6, 0.2, 0.0]); //15
...
fn make_c_render() -> Packet {
    ...
    let bot_right_in = Vertex::new([1.0, 0.2, 0.0]); //7
...
fn make_d_render() -> Packet {
    ...
    let bot_left_in = Vertex::new([0.2, 0.2, 0.0]); //3
    let bot_right_out = Vertex::new([0.8, 0.0, 0.0]); //4
    let bot_right_in = Vertex::new([0.6, 0.2, 0.0]); //5
    let right_mid_out = Vertex::new([1.0, 0.5, 0.0]); //6
    let right_mid_in = Vertex::new([0.8, 0.5, 0.0]); //7
    let top_right_out = Vertex::new([0.8, 1.0, 0.0]); //8
    let top_right_in = Vertex::new([0.6, 0.8, 0.0]); //9
...
fn make_f_render() -> Packet {
    let top_left_out = Vertex::new([0.0, 1.0, 0.0]); //0
    let top_left_in = Vertex::new([0.3, 0.8, 0.0]); //1
    let top_right_top = Vertex::new([1.0, 1.0, 0.0]); //2
    let top_right_bot = Vertex::new([1.0, 0.8, 0.0]); //3
    let mid_left_top = Vertex::new([0.3, 0.6, 0.0]); //4
    let mid_left_bot = Vertex::new([0.3, 0.4, 0.0]); //5
    let mid_right_top = Vertex::new([1.0, 0.6, 0.0]); //6
    let mid_right_bot = Vertex::new([1.0, 0.4, 0.0]); //7
    let bot_left_left = Vertex::new([0.0, 0.0, 0.0]); //8
    let bot_left_right = Vertex::new([0.3, 0.0, 0.0]); //9
...
fn make_g_render() -> Packet {
    ...
    let top_right_bot = Vertex::new([1.0, 0.8, 0.0]); //1
    let top_left_out = Vertex::new([0.0, 1.0, 0.0]); //2
    let top_left_in = Vertex::new([0.2, 0.8, 0.0]); //3
    let bot_left_out = Vertex::new([0.0, 0.0, 0.0]); //4
    let bot_left_in = Vertex::new([0.2, 0.2, 0.0]); //5
    let bot_right_out = Vertex::new([1.0, 0.0, 0.0]); //6
    let bot_right_in = Vertex::new([0.8, 0.2, 0.0]); //7
    let mid_right_out = Vertex::new([1.0, 0.6, 0.0]); //8
    let mid_right_in = Vertex::new([0.8, 0.4, 0.0]); //9
    let mid_mid_top = Vertex::new([0.5, 0.6, 0.0]); //10
    let mid_mid_bot = Vertex::new([0.5, 0.4, 0.0]); //11
...
fn make_h_render() -> Packet {
    ...
    let top_right_right = Vertex::new([1.0, 1.0, 0.0]); //2
    let top_right_left = Vertex::new([0.8, 1.0, 0.0]); //3
    let mid_left_top = Vertex::new([0.2, 0.6, 0.0]); //4
    let mid_left_bot = Vertex::new([0.2, 0.4, 0.0]); //5
    let mid_right_top = Vertex::new([0.8, 0.6, 0.0]); //6
    let mid_right_bot = Vertex::new([0.8, 0.4, 0.0]); //7
    let bot_left_left = Vertex::new([0.0, 0.0, 0.0]); //8
    let bot_left_right = Vertex::new([0.2, 0.0, 0.0]); //9
    let bot_right_right = Vertex::new([1.0, 0.0, 0.0]); //10
    let bot_right_left = Vertex::new([0.8, 0.0, 0.0]); //11
