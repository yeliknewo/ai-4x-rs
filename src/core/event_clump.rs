use events::{GameFromMainGameCity, GameFromMainGameMap, GameFromMainGamePauseMenu, GameFromMainMenu, GameToMainGameCity, GameToMainGameMap, GameToMainGamePauseMenu, GameToMainMenu, MainFromControl, MainFromGame, MainFromRender,
             MainToControl, MainToGame, MainToRender};
    ...
    where ID: Send + Eq
{
    ...
    let (front_game_x_main_game_pause_menu, back_game_x_main_game_pause_menu) = DuoChannel::new_both();
    ...
    (FrontEventClump::new(front_main_x_control, front_main_x_game, front_main_x_render),
     BackEventClump::new(back_main_x_control,
                         back_main_x_game,
                         back_main_x_render,
    ...
    where ID: Send + Eq
{
    ...
    front_game_x_main_game_pause_menu: Option<DuoChannel<GameToMainGamePauseMenu, GameFromMainGamePauseMenu>>,
    back_game_x_main_game_pause_menu: Option<DuoChannel<GameFromMainGamePauseMenu, GameToMainGamePauseMenu>>,
    ...
    where ID: Send + Eq
{
    fn new(main_x_control: DuoChannel<MainFromControl, MainToControl>,
           ...
           front_game_x_main_game_pause_menu: DuoChannel<GameToMainGamePauseMenu, GameFromMainGamePauseMenu>,
           back_game_x_main_game_pause_menu: DuoChannel<GameFromMainGamePauseMenu, GameToMainGamePauseMenu>,
    ...
    pub fn take_front_game_x_main_game_pause_menu(&mut self) -> Option<DuoChannel<GameToMainGamePauseMenu, GameFromMainGamePauseMenu>> {
        self.front_game_x_main_game_pause_menu.take()
    }

    pub fn take_back_game_x_main_game_pause_menu(&mut self) -> Option<DuoChannel<GameFromMainGamePauseMenu, GameToMainGamePauseMenu>> {
        self.back_game_x_main_game_pause_menu.take()
    }

    pub fn take_front_game_x_main_game_map(&mut self) -> Option<DuoChannel<GameToMainGameMap, GameFromMainGameMap>> {
        self.front_game_x_main_game_map.take()
    }

    pub fn take_back_game_x_main_game_map(&mut self) -> Option<DuoChannel<GameFromMainGameMap, GameToMainGameMap>> {
        self.back_game_x_main_game_map.take()
    }

    pub fn take_front_game_x_main_game_city(&mut self) -> Option<DuoChannel<GameToMainGameCity, GameFromMainGameCity>> {
        self.front_game_x_main_game_city.take()
    }

    pub fn take_back_game_x_main_game_city(&mut self) -> Option<DuoChannel<GameFromMainGameCity, GameToMainGameCity>> {
